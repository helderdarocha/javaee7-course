 ...
 */
@WebServlet(name = "PovoarTabelaServlet", urlPatterns = {"/PovoarTabelaServlet"})
public class PovoarTabelaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet InserirTabelaServlet</title>");
                out.println("</head>");
                out.println("<body>");
            ...
            Logger.getLogger(PovoarTabelaServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
