...
public class Livro implements Serializable {
    ...
    // EXERCICIO: Use a anotação abaixo para validar o assunto (obriga o Livro a ter um assunto)
    // @NotNull(message="Selecione um assunto (nos três menus)")
    
    // EXERCÍCIO: Inclua aqui um relacionamento para que o Livro tenha um Assunto
