...
@Singleton
@Startup
@WebService(portName = "AssuntoWebPort", // opcional - default será AssuntoEJBPort
            serviceName = "AssuntoWebService", // opcional - default será AssuntoEJBService
            targetNamespace = "http://biblioteca.ws", // opcional - default será http://biblioteca.ejb (nome do pacote)
            endpointInterface = "biblioteca.ws.AssuntoWebService") // opcional - se não houver, todos os metodos serão incluidos
public class AssuntoEJB implements AssuntoService, AssuntoWebService {
