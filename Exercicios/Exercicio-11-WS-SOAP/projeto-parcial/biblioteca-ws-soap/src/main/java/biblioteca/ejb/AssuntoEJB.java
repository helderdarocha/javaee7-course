...
@Singleton
@Startup
// EXERCICIO: Configure este EJB como um WebService. Implemente usando uma
// Endpoint interface (use a interface disponível no pacote biblioteca.ws
// e use http://biblioteca.ws como targetNamespace.
