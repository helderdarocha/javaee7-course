...
import biblioteca.ejb.BookServicesClientEJB;
...
public class LivroBean implements Serializable {
    ...
    @EJB
    BookServicesClientEJB webService;
    ...
    public String webUpdate() {
        setCurrent(webService.updateFromIsbnDB(current.getIsbn()));
        return null;
    }
    
    public String getCapa(String isbn) {
        return webService.getCoverForISBN(isbn);
    }
}
